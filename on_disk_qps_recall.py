...
fig, ax0 = plt.subplots(1, 1, figsize=(4, 1.5))
ax1 = ax0.twinx()
...
ax1.set_ylabel('Recall R@1 (%)', fontsize=label_font)
ax0.set_ylabel('QPS', fontsize=label_font)
ax0.set_xticks(x)
ax0.set_xticklabels(x_labels, fontsize=tick_label_font, rotation=30)

ax0.legend([rects, line], ["QPS", "Recall"], facecolor='white', framealpha=1, frameon=True, loc=(0.65, 0.42), fontsize=legend_font, ncol=1)
...
plt.savefig('./out_img/on_disk_qps_recall.png', transparent=False, dpi=200, bbox_inches="tight")
plt.show()
