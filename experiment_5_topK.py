...
y_QPS = np.array([11880, 11035, 7837, 5399, 4256, 2622, 1064, 594])
y_recall = np.array([0.3461, 0.8031, 0.8713, 0.9125, 0.9216, 0.9238, 0.9247, 0.9247]) * 100
...
plt.savefig('./out_img/experiment_5_topK.png', transparent=False, dpi=200, bbox_inches="tight")
plt.show()
