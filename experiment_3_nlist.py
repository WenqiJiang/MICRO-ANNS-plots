...
y_QPS = np.array([2727, 4798, 7737, 11712, 8358, 4198, 2130])
y_recall = np.array([0.8070, 0.8108, 0.7992, 0.7990, 0.7836, 0.7695, 0.7459]) * 100
...
plt.savefig('./out_img/experiment_3_nlist.png', transparent=False, dpi=200, bbox_inches="tight")
plt.show()
