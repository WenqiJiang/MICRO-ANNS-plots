...
y_no_OPQ = np.array([0, 2783, 4418, 8569, 8314, 4198, 2130])
y_OPQ = np.array([3338, 5872, 7460, 11035, 8276, 4198, 2130])
...
plt.savefig('./out_img/experiment_2_algorithm_settings.png', transparent=False, dpi=200, bbox_inches="tight")
plt.show()
