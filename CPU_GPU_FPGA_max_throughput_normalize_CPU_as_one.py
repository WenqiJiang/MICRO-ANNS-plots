...
# Here, normalize CPU performance as 1
y_fpga = np.array([max_qps_fpga_R1, max_qps_fpga_R10, max_qps_fpga_R100]) / FPGA_FLOPS / y_cpu
y_fpga_optimized = np.array([max_qps_fpga_optimized_R1, max_qps_fpga_optimized_R10, max_qps_fpga_optimized_R100]) / FPGA_FLOPS / y_cpu
y_gpu = np.array([max_qps_gpu_R1, max_qps_gpu_R10, max_qps_gpu_R100]) / GPU_FLOPS / y_cpu
y_cpu = y_cpu / y_cpu
...
ax.legend([rects_cpu, rects_gpu, rects_fpga, rects_fpga_optimized], legend_list, facecolor='white', framealpha=1, frameon=False, loc=(0.05, 0.67), fontsize=legend_font, ncol=2)
