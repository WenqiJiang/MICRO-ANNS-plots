...
y_QPS = np.array([16493, 16542, 16490, 16469, 11711, 5933, 2930])
y_recall = np.array([0.3759, 0.5139, 0.6444, 0.7402, 0.7990, 0.8288, 0.8405]) * 100

x_labels = ['nprobe=1', 'nprobe=2', 'nprobe=4',\
    'nprobe=8', 'nprobe=16', 'nprobe=32', 'nprobe=64']
...
ax0.legend([rects, line], ["QPS", "Recall"], facecolor='white', framealpha=1, frameon=True, loc=(0.81, 0.42), fontsize=legend_font, ncol=1)
...
plt.savefig('./out_img/experiment_4_nprobe.png', transparent=False, dpi=200, bbox_inches="tight")
plt.show()
